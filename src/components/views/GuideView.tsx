    ...
    <div>
        <section className="card-inputs">
            ...
            <p className="guide-lead">
                作り方は 2 通りあります。ゼロから描くなら <b>ドット打ちエディタ</b>、
                すでにある AA を持ち込むなら <b>AA変換</b> を使ってください。
                どちらも最後は「コピーしてゲームに貼り付け」で同じです。
            </p>
            <ol className="guide-list">
                <li>
                    <b>ドット打ちエディタ</b>でマス目をタップして絵を描く。
                    すでに AA がある場合は <b>AA変換</b>に貼り付ける。
                </li>
        ...
        <section className="card-inputs">
            ...
            <ul className="guide-list">
                ...
                <li>
                    スマホでマスが小さくて狙いにくいときは <b>拡大</b> を押してください。
                    拡大中は <b>1 本指で描画・2 本指で横スクロール</b> になります。
                </li>
                <li>
