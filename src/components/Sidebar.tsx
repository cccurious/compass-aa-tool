    ...
    return (
        <nav className={`side-menu ${isOpen ? 'open' : ''}`} id="side-menu">
            ...
            <ul>
                <li>
                    <button
                        className={`menu-link ${currentView === 'dot' ? 'active' : ''}`}
                        onClick={() => onViewChange('dot')}
                    >
                ...
                <li>
                    <button
                        className={`menu-link ${currentView === 'aa' ? 'active' : ''}`}
                        onClick={() => onViewChange('aa')}
                    >
            ...
            <div className="menu-header" style={{ borderTop: '1px solid var(--border-color)' }}>
                その他
            </div>
            <ul>
                <li>
                    <button
                        className={`menu-link ${currentView === 'guide' ? 'active' : ''}`}
